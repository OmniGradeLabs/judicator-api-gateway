...
import com.judicator.gateway.modules.identity.dto.authentication.response.AuthenticationResponse;
...
public class AuthenticationController {
  ...
  @Operation(
      ...
      description =
          "Xác thực thông tin đăng nhập, tạo session và trả về access token kèm refresh token HttpOnly cookie.")
  ...
  @Operation(
      summary = "Đăng xuất tất cả sessions của user hiện tại",
      description =
  ...
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "Đăng xuất tất cả sessions thành công",
            content = @Content(schema = @Schema(implementation = ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "401",
